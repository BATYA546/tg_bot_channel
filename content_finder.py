        ...
        quality_posts = [
            {
                ...
                'image_url': 'https://upload.wikimedia.org/wikipedia/commons/3/3c/Sputnik_1.jpg',
            ...
            },
            {
                ...
                'url': '',
                # Прямая ссылка на изображение
                'image_url': 'https://upload.wikimedia.org/wikipedia/commons/1/10/Alexander_Graham_Bell.jpg',
                'found_date': datetime.now()
            },
            {
                ...
                'url': '',
                # Прямая ссылка на изображение
                'image_url': 'https://upload.wikimedia.org/wikipedia/commons/5/5e/First_flight2.jpg',
                'found_date': datetime.now()
            },
            {
                ...
                'url': '',
                # Прямая ссылка на изображение
                'image_url': 'https://upload.wikimedia.org/wikipedia/commons/5/5e/View_from_the_Window_at_Le_Gras%2C_Joseph_Nic%C3%A9phore_Ni%C3%A9pce.jpg',
                'found_date': datetime.now()
            },
            {
                ...
                'url': '',
                # Прямая ссылка на изображение
                'image_url': 'https://upload.wikimedia.org/wikipedia/commons/6/6c/ENIAC_Penn1.jpg',
                'found_date': datetime.now()
            }
        ]
