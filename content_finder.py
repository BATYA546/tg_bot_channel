...
class ContentFinder:
    ...
    def search_content(self, max_posts=2):
        ...
        # Используем качественный контент с работающими изображениями
        ...
        quality_posts = [
            {
                ...
                'category': 'space',
                'url': '',
                # Правильный URL для Wikimedia
                'image_url': 'https://commons.wikimedia.org/wiki/File:Sputnik_1.jpg#/media/Файл:Sputnik_1.jpg',
            ...
            },
            {
                ...
                'url': '',
                # Правильный URL для Wikimedia
                'image_url': 'https://commons.wikimedia.org/wiki/File:Alexander_Graham_Bell.jpg#/media/Файл:Alexander_Graham_Bell.jpg',
                'found_date': datetime.now()
            },
            {
                ...
                'url': '',
                # Правильный URL для Wikimedia
                'image_url': 'https://commons.wikimedia.org/wiki/File:First_flight2.jpg#/media/Файл:First_flight2.jpg',
                'found_date': datetime.now()
            },
            {
                ...
                'url': '',
                # Правильный URL для Wikimedia
                'image_url': 'https://commons.wikimedia.org/wiki/File:View_from_the_Window_at_Le_Gras,_Joseph_Nicéphore_Niépce.jpg#/media/Файл:View_from_the_Window_at_Le_Gras,_Joseph_Nicéphore_Niépce.jpg',
                'found_date': datetime.now()
            },
            {
                ...
                'url': '',
                # Правильный URL для Wikimedia
                'image_url': 'https://commons.wikimedia.org/wiki/File:ENIAC_Penn1.jpg#/media/Файл:ENIAC_Penn1.jpg',
                'found_date': datetime.now()
            }
        ]
