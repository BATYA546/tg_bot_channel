...
Эта фотография положила начало развитию фотографии как искусства и технологии.""",
            ...
            },
            {
                ...
                'content': """12 апреля 1961 года Юрий Гагарин стал первым человеком, полетевшим в космос на корабле «Восток-1».

📅 Дата: 12 апреля 1961 года
👨‍🚀 Космонавт: Юрий Гагарин
🚀 Корабль: Восток-1
⏱️ Продолжительность: 108 минут

Это историческое событие открыло новую эру в освоении космоса.""",
                'category': 'space'
            },
            {
                'title': 'Изобретение телефона',
                'content': """В 1876 году Александр Белл запатентовал первый практический телефон.

📅 Год изобретения: 1876
👨‍🔬 Изобретатель: Александр Белл
💡 Патент: US174465
🌍 Значение: революция в общении

Первые слова, переданные по телефону: «Мистер Ватсон, идите сюда, вы мне нужны».""",
                'category': 'technology'
            }
        ]
